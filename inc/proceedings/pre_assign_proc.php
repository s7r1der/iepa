...
<table align=center width=60% class=myTable-gray>
	<tr valign=center><td class=titulo colspan=3>DESEA AGREGAR ESTE ACTA</b></td></tr>	
	...
	<tr><td align=center colspan=3>
		<table width=100% align=center bgcolor="WHITE">
			...
			<tr valign=middle><td align=left><B>FECHA ACTA: </td><td><?php echo $_POST["proc_date"];?></td></tr>

			<tr><td align=center colspan=2><hr></td></tr>	

			<tr><td align=left><B>TITULO</td><td><?php echo "<b><font size=6>".$_POST["proc_title"]."</font></b>"; ?></td></tr>

			<tr><td align=center colspan=2><hr></td></tr>	
			
			<tr><td align=left><b>DETALLE DEL ACTA: </b></td><td><?php echo $_POST["proc_desc"];?></td></tr>

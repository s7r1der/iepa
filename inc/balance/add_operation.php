...
<FORM action=<?php echo $_SERVER["PHP_SELF"]; ?> method="POST">
	...
	<table align=center width=60% class=myTable-gray>
		<tr valign=center>
			<td class=titulo colspan=3>CREAR REGISTRO DE UNA OPERACION</b></td>
		</tr>
			...
			<td align=center colspan=3>
				<table width=100% align=center bgcolor="WHITE">
					...
					<tr valign=middle>
						...
						<td>
							<input type="text" name="op_date" id="datepicker" readonly="readonly" size="12" />
						</td>
					</tr>
					...
					<tr valign=middle>
						...
						<td>
							<input type="text" name="op_val" size="12" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><textarea rows=5 cols=80 name=op_desc></textarea></td>
					</tr>
		...
		<tr valign=top>
			<td align=center colspan=3><input type=submit class=boton id=butt_log name="event" value="Asignar Operacion">
			<td>
		</tr>
